...
make_plot_and_stat <- function(exp_name) {
  #exp_name = "world0n_divided_size"
  dirs = list(exp_name)
  #dirs = list.files("./output");
  #dirs = list("world0n_divided_size", "world1n_divided_size", "world2nn_divided_size", "world3nn_divided_size", "world4n_divided_size")
  ...
  pdf(exp_name)#paste(dirs, collapse="_vs_"))
  print(plot1)
  dev.off()
  ...
  write.csv(exp_maxes, (paste("exp_makes_files/exp_makes_", exp_name, ".csv")))
...
dir.create("exp_makes_files")
exp_name = "world3nn_divided_size"
dirs = list(exp_name)

#dirs = list.files("./output");
#dirs = list("world0n_divided_size", "world1n_divided_size", "world2nn_divided_size", "world3nn_divided_size", "world4n_divided_size")
lapply(dirs, make_plot_and_stat)
