...
with open("exp_maxes.csv", "rb") as f:
    reader = csv.reader(f)
    reader.next()
    ...
    for row in reader:
        ...
        #model name - construct a name which can be sorted by fitness values
        ...
        #copy model file
        model_src=os.path.join("output",(row[0].split('.'))[0],"robot_"+row[1]+".sdf")
        print model_src
